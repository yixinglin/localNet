...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.configureTable.setHorizontalHeaderItem(4, item)
        item = QtWidgets.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignVCenter)
        ...
        self.shopName = QtWidgets.QLineEdit(self.layoutWidget)
        self.shopName.setObjectName("shopName")
        self.verticalLayout.addWidget(self.shopName)
        self.label_2 = QtWidgets.QLabel(self.layoutWidget)
        self.label_2.setObjectName("label_2")
        self.verticalLayout.addWidget(self.label_2)
        self.pricingFreq = QtWidgets.QSpinBox(self.layoutWidget)
    ...
    def retranslateUi(self, Dialog):
        ...
        item = self.configureTable.horizontalHeaderItem(4)
        item.setText(_translate("Dialog", "L.Price"))
        item = self.configureTable.horizontalHeaderItem(5)
        item.setText(_translate("Dialog", "Strategy"))
