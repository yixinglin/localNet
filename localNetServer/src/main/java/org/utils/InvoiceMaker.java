...
public class InvoiceMaker {
    ...
    private String tempDirectory;  // Directory for temporal files.
    private String templateDocFile;  // 模板文件
    private String targetPdfDirectory;  // Directory for PDF output;
    private Path outputPdfPath;
    private Path outputDocxPath;

    public InvoiceMaker() {
        this.tempDirectory = ".";
        this.templateDocFile = ".";
        this.targetPdfDirectory = ".";
    }
    public InvoiceMaker(String tempDirectory, String templateDocFile, String pdfOutDir) {
        this.tempDirectory = tempDirectory;
        this.templateDocFile = templateDocFile;
        this.targetPdfDirectory = pdfOutDir;
    }
